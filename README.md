...
| Опция 1: сверка с законодательством и стандартами | `lib/compliance.ts`, `data/requirements.json` (IIA, Закон РК «Об АО», 208-ФЗ) | раздел 7 выгружаемого заключения, `result.compliance` |
