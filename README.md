...
flowchart LR
  ...
  P5 --> P5b{5б. Комплекты сопоставимы?}
  P5b -->|нет| STOP[Сообщение пользователю, анализ не проводится]
  P5b -->|да| P6[6. LLM-сопоставление изменённых функций]
